...
# Program reads the result file of NEC modeling (.nec), finds frequencies of analysis, sources
# loads and their values, currents in sources and loads, calculates mutual
